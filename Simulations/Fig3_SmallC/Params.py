...
#General stats
Repeats =100#20#10#20
#Whether all the patches start infected or not
SingleActive = False

#Prob of Patch 
PList = np.asarray([0.01,0.1,0.75])#np.asarray([0.005,0.001])#np.linspace(0.1,1,10)

#Time taken for sim to run
T = int(1e9)#int(1e7)#6)#40000000#50000000#10000000#100000000

#Fitness of the mutant
FList = np.asarray([1])#np.asarray([0.9,0.95,0.99])#np.linspace(0.1,1,10)
